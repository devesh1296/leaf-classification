...
image_data = [] 
for image_file in os.listdir('F:\\Dev\\MLprojects\\Leaf Classification\\images'):
    image_data.append(imresize(imread(os.path.join('F:\\Dev\\MLprojects\\Leaf Classification\\images', image_file)),(img_height,img_width)).reshape((img_height, img_width,1)).astype(np.float32))
