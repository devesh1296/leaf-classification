...
train = pd.read_csv(os.path.join(data_dir, "F:\\Dev\\MLprojects\\Leaf Classification.\\train.csv"))
test = pd.read_csv(os.path.join(data_dir, "F:\\Dev\\MLprojects\\Leaf Classification.\\test.csv"))
image_data = {}
images_dir = os.path.join(data_dir, "F:\\Dev\\MLprojects\\Leaf Classification\\images")
